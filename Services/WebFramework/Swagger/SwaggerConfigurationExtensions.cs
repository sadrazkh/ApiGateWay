...
namespace Services.WebFramework.Swagger
{
    public static class SwaggerConfigurationExtensions
    {
        public static void AddSwagger(this IServiceCollection services)
        {
            ...
            {
                //var xmlDocPath = Path.Combine("" , "ServerApplication.xml");
                ...
                options.SwaggerDoc("2", new OpenApiInfo { Version = "2", Title = "API V2" });
        ...
        public static IApplicationBuilder UseSwaggerAndUI(this IApplicationBuilder app)
        {
            ...
            app.UseSwaggerUI(options =>
            {
                ...
                options.SwaggerEndpoint("/swagger/2/swagger.json", "V2 Docs");
            ...
            app.UseReDoc(options =>
            {
                ...
                //options.SpecUrl("/swagger/vAdmin/swagger.json");
                options.SpecUrl("/swagger/2/swagger.json");
